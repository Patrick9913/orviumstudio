...
export const TechnologiesCarrusel: React.FC = () => {
  ...
  return (
    <div className="w-full py-16 bg-white overflow-hidden border-b border-gray-100">
     <div className="max-w-7xl mx-auto px-4 mb-16">
        <h3 className="text-3xl md:text-4xl font-light text-center text-gray-900 tracking-tight mb-4">
          Tecnología que Impulsa tu Negocio
        </h3>
        <p className="text-center text-gray-500 text-lg font-light max-w-2xl mx-auto">
          Usamos las herramientas más avanzadas para crear sitios web rápidos, seguros y escalables.
        </p>
      </div> 
